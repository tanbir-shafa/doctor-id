      ...
      sections={[
        ...
        },
        {
          ...
          paragraphs: [
            ...
            `We use cookies and similar technologies that are strictly necessary to run the site securely — including those set by Cloudflare Turnstile to tell humans from automated abuse, and a small cookie that remembers your cookie choice. We also use Google Analytics 4 to understand how the site is used; these analytics cookies are enabled by default when you visit the site, and we show a notice telling you so. You can opt out at any time by choosing "Decline" in the cookie notice or via the "Cookie preferences" link in our footer, after which our analytics cookies and scripts will not load.`,
          ],
        },
        {
