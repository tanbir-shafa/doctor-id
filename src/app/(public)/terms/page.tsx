      ...
      sections={[
        ...
        },
        {
          ...
          paragraphs: [
            ...
            `You must not, and must not authorise, enable, or assist any other person, bot, agent, or automated system to: scrape, crawl, spider, harvest, index, cache, copy, mirror, bulk-download, or otherwise systematically extract or collect any data or content from the Service; access the Service through any robot, scraper, headless browser, or other automated means; or circumvent, probe, disable, or test its security, rate-limiting, access-control, or bot-protection measures, or place an unreasonable load on its infrastructure. The only exception is a general-purpose search engine indexing the Service for ordinary search results in accordance with our robots.txt.`,
            `You must not use the Service, or any data or content obtained from it, to train, fine-tune, develop, benchmark, or operate any artificial-intelligence or machine-learning system, large language model, generative-AI tool, or dataset, and you must not carry out text or data mining on the Service. No licence for text or data mining or for any artificial-intelligence use is granted by these Terms or by access to the Service; we expressly reserve all such rights, and this clause is an express reservation of rights for the purposes of any applicable text-and-data-mining or copyright law. We deploy technical measures to enforce these restrictions — including robots.txt directives, machine-readable rights-reservation signals, rate-limiting, and bot protection — and a breach of this clause is a serious violation of these Terms that may result in immediate termination and legal action.`,
